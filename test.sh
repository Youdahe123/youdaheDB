...
commands=(
    ...
    "${CYAN}cargo test wal_tests${RESET}        run only the WAL layer tests"
    "${CYAN}cargo test -- --ignored${RESET}     run future layer stubs"
...
run_layer "Sharding"                        "sharding_tests"     "pending"
run_layer "Transactions"                    "transaction_tests"  "pending"
